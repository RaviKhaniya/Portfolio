...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "khaniyaravi999@gmail.com";
  ...
  return (
    <div
      className={cn(
        ...
        className,
        { "h-full lg:h-[400px]": id === 6, "lg:h-96": id === 5 } 
      )}
      style={{
    ...
    >
      <div className={`${id === 6 && "flex justify-center items-center"} h-full`}>
        ...
        {spareImg && id === 5 && (
          <div className="absolute right-0 bottom-0 w-full opacity-90">
            <img
              src={spareImg}
              alt={spareImg}
        ...
        {id === 6 && (
          <>
            <BackgroundGradientAnimation>
              <div className="absolute inset-0 flex items-center justify-center text-white font-bold text-2xl lg:text-4xl">
